                ...
                <?php 
                    ...
                    if($isAnyCandidateAdded > 0)
                    {
                        ...
                        while($row = mysqli_fetch_assoc($fetchingData))
                        {
                            ...
                            if ($execFetchingElectionNameQuery !== null && isset($execFetchingElectionNameQuery['election_topic'])) {
                                 $election_name = $execFetchingElectionNameQuery['election_topic'];
                            } else {
                                // Handle the case where $execFetchingElectionNameQuery is null or 'election_topic' doesn't exist.
...
<script>
    const DeleteData = (c_id) => {
        let c = confirm("Are you sure you really want to delete this candidate?");
